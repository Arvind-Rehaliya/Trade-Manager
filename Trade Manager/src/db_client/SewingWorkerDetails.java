...
import gui.Panel_SewingWorkerDetails;
import gui.homePage;
...
public class SewingWorkerDetails {
    ...
    Object[] col; public String table_name = "emp_sewdetails"; String file_name = "Emp_SewDetails.config"; JScrollPane sp = Panel_SewingWorkerDetails.sp;
    
     public SewingWorkerDetails() {
        prepareColumnData();
        createTable();
        tableRendering();
        getMaxLastUpdNum();
