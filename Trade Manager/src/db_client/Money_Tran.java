...
public class Money_Tran {
    ...
    JPopupMenu menu = null; JMenuItem add, dlt, ref; JSeparator sept;
    Object[] col; public String table_name = "money_tran"; String file_name = "Money_Tran.config"; JScrollPane sp = Panel_money.sp;
