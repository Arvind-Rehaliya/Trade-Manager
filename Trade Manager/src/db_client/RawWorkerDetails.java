...
import gui.Panel_RawWorkerDetails;
import gui.homePage;
...
public class RawWorkerDetails {
    ...
    Object[] col; public String table_name = "emp_rawdetails"; String file_name = "Emp_RawDetails.config"; JScrollPane sp = Panel_RawWorkerDetails.sp;
    
    public RawWorkerDetails() {
        prepareColumnData();
        createTable();
        tableRendering();
        getMaxLastUpdNum();
