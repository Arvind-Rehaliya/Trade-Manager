...
public class Panel_RawMaterial extends javax.swing.JPanel {
    RawMaterial rm;
    
    public Panel_RawMaterial() { 
         initComponents();
         rm = new RawMaterial();
     }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(Display, org.openide.util.NbBundle.getMessage(Panel_RawMaterial.class, "Panel_RawMaterial.Display.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(ad, org.openide.util.NbBundle.getMessage(Panel_RawMaterial.class, "Panel_RawMaterial.ad.text")); // NOI18N
    ...
    private void DisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayActionPerformed
        if(user_perm.charAt(0) == '0') rm.noRowDisplay();  else rm.display();
    ...
    public RawMaterial get() { return rm;  }   
