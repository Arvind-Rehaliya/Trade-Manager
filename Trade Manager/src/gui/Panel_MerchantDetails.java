...
public class Panel_MerchantDetails extends javax.swing.JPanel {
   MerchantDetails md;
     
   public Panel_MerchantDetails() { 
        initComponents();
        md = new MerchantDetails();
    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(Display, org.openide.util.NbBundle.getMessage(Panel_MerchantDetails.class, "Panel_MerchantDetails.Display.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(ad, org.openide.util.NbBundle.getMessage(Panel_MerchantDetails.class, "Panel_MerchantDetails.ad.text")); // NOI18N
    ...
    private void DisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayActionPerformed
        if(user_perm.charAt(0) == '0') md.noRowDisplay();  else md.display();
    ...
    public MerchantDetails get() { return md; }  
