...
public class Panel_Raw extends javax.swing.JPanel {
    RawWorker rw;
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(Display, org.openide.util.NbBundle.getMessage(Panel_Raw.class, "Panel_Raw.Display.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(ad, org.openide.util.NbBundle.getMessage(Panel_Raw.class, "Panel_Raw.ad.text")); // NOI18N
    ...
    private void DisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayActionPerformed
        if(user_perm.charAt(0) == '0') rw.noRowDisplay();  else rw.display();
    ...
    public RawWorker get() { return rw; } 
