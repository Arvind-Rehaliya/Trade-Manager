...
public class Panel_Ready extends javax.swing.JPanel {
    Ready r;
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(Display, org.openide.util.NbBundle.getMessage(Panel_Ready.class, "Panel_Ready.Display.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(ad, org.openide.util.NbBundle.getMessage(Panel_Ready.class, "Panel_Ready.ad.text")); // NOI18N
    ...
    private void DisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayActionPerformed
        if(user_perm.charAt(0) == '0') r.noRowDisplay();  else r.display();
